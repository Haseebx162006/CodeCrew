...
from Prompts.testing_agent_prompt import testing_agent_prompt
...
class TestingAgent:
    ...
    def execute(
        ...
        thread_id = f"{session_id}_testing" if session_id else subtask.id
